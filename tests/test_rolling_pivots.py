...
class TestPivotPoints:
    ...
    def test_camarilla(self, quotes):
        results = indicators.get_rolling_pivots(
            quotes[:38], 10, 0, PivotPointType.CAMARILLA
        )
    ...
    def test_fibonacci(self, quotes_intraday):
        results = indicators.get_rolling_pivots(
            quotes_intraday[:300], 44, 15, PivotPointType.FIBONACCI
        )
    ...
    def test_woodie(self, quotes_intraday):
        results = indicators.get_rolling_pivots(
            quotes_intraday, 375, 16, PivotPointType.WOODIE
        )
    ...
    def test_bad_data(self, quotes_bad):
        r = indicators.get_rolling_pivots(quotes_bad, 5, 5)
        assert 502 == len(r)
    ...
    def test_removed(self, quotes):
        ...
        offset_periods = 9
        results = indicators.get_rolling_pivots(
            quotes, window_periods, offset_periods, PivotPointType.STANDARD
        )
