...
class TestBeta:
    def test_all(self, quotes, quotes_other):
        results = indicators.get_beta(quotes_other, quotes, 20, BetaType.ALL)
    ...
    def test_standard(self, quotes, quotes_other):
        results = indicators.get_beta(quotes_other, quotes, 20, BetaType.STANDARD)
    ...
    def test_up(self, quotes, quotes_other):
        results = indicators.get_beta(quotes_other, quotes, 20, BetaType.UP)
    ...
    def test_down(self, quotes, quotes_other):
        results = indicators.get_beta(quotes_other, quotes, 20, BetaType.DOWN)
    ...
    def test_bad_data(self, quotes_bad):
        r = indicators.get_beta(quotes_bad, quotes_bad, 15, BetaType.STANDARD)
        assert 502 == len(r)

        r = indicators.get_beta(quotes_bad, quotes_bad, 15, BetaType.UP)
        assert 502 == len(r)

        r = indicators.get_beta(quotes_bad, quotes_bad, 15, BetaType.DOWN)
        assert 502 == len(r)

    def test_big_data(self, quotes_big):
        r = indicators.get_beta(quotes_big, quotes_big, 150, BetaType.ALL)
        assert 1246 == len(r)
    ...
    def test_removed(self, quotes, quotes_other):
        results = indicators.get_beta(quotes_other, quotes, 20).remove_warmup_periods()
    ...
    def test_condense(self, quotes, quotes_other):
        results = indicators.get_beta(quotes_other, quotes, 20, BetaType.ALL).condense()
