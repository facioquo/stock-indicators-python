...
class TestALMA:
    def test_standard(self, quotes):
        results = indicators.get_alma(quotes, lookback_periods=10, offset=0.85, sigma=6)
    ...
    def test_bad_data(self, quotes_bad):
        r = indicators.get_alma(quotes_bad, 14, 0.5, 3)

        assert 502 == len(r)

    def test_removed(self, quotes):
        results = indicators.get_alma(quotes, 10, 0.85, 6).remove_warmup_periods()
    ...
    def test_condense(self, quotes):
        results = indicators.get_alma(quotes, 10, 0.85, 6).condense()
    ...
    def test_exceptions(self, quotes):
        ...
        with pytest.raises(ArgumentOutOfRangeException):
            indicators.get_alma(quotes, 10, 0.5, 0)
