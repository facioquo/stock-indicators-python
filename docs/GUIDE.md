...
Find and install the [stock-indicators](https://pypi.org/project/stock-indicators/) Python package into your environment. See [more help](https://packaging.python.org/tutorials/installing-packages/) for installing packages.
