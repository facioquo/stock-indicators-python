...
class ROCResults(IndicatorResults[ROCResult]):
    """
    ...
    def __init__(self, data: Iterable, wrapper_class: Type[ROCResult]):
...
class ROCWBResults(IndicatorResults[ROCWBResult]):
    """
    ...
    def __init__(self, data: Iterable, wrapper_class: Type[ROCWBResult]):
        super().__init__(data, wrapper_class)
